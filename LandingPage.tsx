  ...
  return (
    <div className={darkMode ? "dark font-sans overflow-x-hidden" : "font-sans overflow-x-hidden"}>
      ...
      >
        ...
        >
          <h1 className={`text-5xl md:text-6xl font-extrabold mb-4 ${textColor}`}>
            30 Day Build, Use, Sell Challenge
          </h1>
          <p className={`text-lg md:text-xl mb-8 ${textColor}`}>
            Hope on the 30 BUS To The Destination of Your Choice
          </p>
          <motion.a
            href="#tool-of-day"
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        <motion.div
          className="absolute bg-white opacity-10 rounded-full w-72 h-72 -left-32 -top-20"
          animate={{ x: [0, 100, 0], y: [0, 50, 0] }}
          transition={{ repeat: Infinity, duration: 8, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute bg-white opacity-10 rounded-full w-48 h-48 -right-20 top-1/2"
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: teal }}>
            Tool of the Day
          </h2>
          <motion.div
            ...
            whileHover={{ y: -8 }}
          >
            <h3 className="text-2xl font-semibold mb-4" style={{ color: darkMode ? "#fff" : "#333" }}>
              [Insert Tool Name]
            </h3>
            <p className={`mb-6 ${cardText}`}>
              Brief description of today’s featured AI tool. Explain how it helps accelerate your workflow.
            </p>
            <motion.a
              href="[Tool Link]"
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: gold }}>
            Free 30-Day Bonus: ClickDone
          </h2>
          <p className={`mb-8 ${darkMode ? "text-gray-300" : "text-gray-700"}`}>
            Get 30 days of free access to ClickDone, our AI-powered productivity suite for task automation.
          </p>
          <motion.a
            href="[ClickDone Link]"
            className="px-8 py-4 rounded-full font-semibold shadow-lg"
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4" style={{ color: darkMode ? "#fff" : "#333" }}>
            Referral Link
          </h2>
          <p className={`mb-4 ${cardText}`}>
            Share the love and earn rewards! Use or share your unique referral link below.
          </p>
          <motion.div className="inline-block bg-gray-100 dark:bg-gray-700 px-6 py-3 rounded-full shadow-inner" whileHover={{ scale: 1.02 }}>
